...
./dsusers.py $CWD/adXtract_$3/$3.export/datatable* $CWD/adXtract_$3/$3.export/link_table* $CWD/adXtract_$3/Maps/ --passwordhashes --pwdformat ophc --passwordhistory --syshive $2 --lmoutfile $CWD/adXtract_$3/$3_allLMhashes.txt --ntoutfile $CWD/adXtract_$3/$3_allNTLMhashes.txt --csvoutfile $CWD/adXtract_$3/$3_UserAccountOut.csv
